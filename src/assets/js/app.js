...
App.config(['$stateProvider', '$urlRouterProvider',
    function ($stateProvider, $urlRouterProvider) {
        $urlRouterProvider.otherwise('/messages/campaigns');
        ...
        $stateProvider
            ...
            .state('messagesCategories', {
                ...
                templateUrl: 'assets/views/messages_categories.html',
            ...
            .state('messagesCampaigns', {
                ...
                templateUrl: 'assets/views/messages_campaigns.html',
            ...
            .state('assignGroupToCampaign', {
                url: '/messages/assign_groups_to_campaign/:cp_id',
                templateUrl: 'assets/views/assign_groups_to_campaign.html',
            ...
            .state('messages', {
                url: '/messages/messages/:cp_id/:gp_id/:gp_name',
            ...
            .state('messagesMedia', {
                url: '/messages/media',
                templateUrl: 'assets/views/messages_media.html',
            ...
            .state('messagesGroups', {
                url: '/messages/groups',
                templateUrl: 'assets/views/messages_groups.html',
            ...
            .state('optimizer', {
                url: '/optimizer/zeropark',
                templateUrl: 'assets/views/optimizer_page.html',
            ...
            .state('reportingOverview', {
                url: '/reporting/overview',
                templateUrl: 'assets/views/reporting_overview.html',
                controller: 'ReportingOverview',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('monitoringLinkChecker',{
                url: '/monitoring/link-checker',
                templateUrl: 'assets/views/monitoring_link_checker.html',
                controller: 'MonitoringLinkChecker',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('monitoringCampaignAlerts',{
                url: '/monitoring/campaign-alerts',
                templateUrl: 'assets/views/campaign_alerts.html',
                controller: 'MonitoringCampaignAlerts',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
                    ...
                    // campaigns: function (VCampaignService) {
                    //     return VCampaignService.all().then(function (res) {
...
App.controller('AppCtrl', ['$scope', '$localStorage', '$window', '$location',
...
// Declare apiHostUrl constant
App.constant('apiHostUrl', 'http://mobrevteam.com');
// App.constant('apiHostUrl', 'http://localhost:5000');
